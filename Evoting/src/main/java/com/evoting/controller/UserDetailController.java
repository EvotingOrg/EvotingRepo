...
public class UserDetailController implements Serializable {
    ...
    @EJB
    private com.evoting.facade.UserDetailFacade ejbFacade;
    private List<UserDetail> items = null;
    private UserDetail selected;
    ...
    public void setSelected(UserDetail selected) {
    ...
    public UserDetail prepareCreate() {
        selected = new UserDetail();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("UserDetailCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("UserDetailUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("UserDetailDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public UserDetail getUserDetail(java.lang.Long id) {
